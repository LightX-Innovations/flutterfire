...
PigeonMultiFactorSession PigeonMultiFactorSession::FromEncodableList(const EncodableList& list) {
  PigeonMultiFactorSession decoded(
...
void PigeonPhoneMultiFactorAssertion::set_verification_id(std::string_view value_arg) {
...
void PigeonPhoneMultiFactorAssertion::set_verification_code(std::string_view value_arg) {
...
PigeonPhoneMultiFactorAssertion PigeonPhoneMultiFactorAssertion::FromEncodableList(const EncodableList& list) {
  PigeonPhoneMultiFactorAssertion decoded(
    std::get<std::string>(list[0]),
...
void PigeonMultiFactorInfo::set_display_name(const std::string_view* value_arg) {
...
void PigeonMultiFactorInfo::set_phone_number(const std::string_view* value_arg) {
...
PigeonMultiFactorInfo PigeonMultiFactorInfo::FromEncodableList(const EncodableList& list) {
  PigeonMultiFactorInfo decoded(
...
PigeonActionCodeInfo& PigeonActionCodeInfo::operator=(const PigeonActionCodeInfo& other) {
  operation_ = other.operation_;
  data_ = std::make_unique<PigeonActionCodeInfoData>(*other.data_);
  return *this;
}
...
PigeonActionCodeInfo PigeonActionCodeInfo::FromEncodableList(const EncodableList& list) {
  PigeonActionCodeInfo decoded(
    ...
    std::any_cast<const PigeonActionCodeInfoData&>(std::get<CustomEncodableValue>(list[1])));
  return decoded;
}
...
void PigeonAdditionalUserInfo::set_provider_id(const std::string_view* value_arg) {
...
void PigeonAdditionalUserInfo::set_authorization_code(const std::string_view* value_arg) {
  authorization_code_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonAdditionalUserInfo::set_authorization_code(std::string_view value_arg) {
...
PigeonAdditionalUserInfo PigeonAdditionalUserInfo::FromEncodableList(const EncodableList& list) {
  PigeonAdditionalUserInfo decoded(
    std::get<bool>(list[0]));
...
PigeonAuthCredential PigeonAuthCredential::FromEncodableList(const EncodableList& list) {
  PigeonAuthCredential decoded(
    std::get<std::string>(list[0]),
    std::get<std::string>(list[1]),
    list[2].LongValue());
...
PigeonUserDetails& PigeonUserDetails::operator=(const PigeonUserDetails& other) {
  user_info_ = std::make_unique<PigeonUserInfo>(*other.user_info_);
  provider_data_ = other.provider_data_;
  return *this;
}
...
PigeonUserDetails PigeonUserDetails::FromEncodableList(const EncodableList& list) {
  PigeonUserDetails decoded(
    std::any_cast<const PigeonUserInfo&>(std::get<CustomEncodableValue>(list[0])),
...
PigeonUserCredential::PigeonUserCredential(
 ...
 : user_(user ? std::make_unique<PigeonUserDetails>(*user) : nullptr),
    additional_user_info_(additional_user_info ? std::make_unique<PigeonAdditionalUserInfo>(*additional_user_info) : nullptr),
    credential_(credential ? std::make_unique<PigeonAuthCredential>(*credential) : nullptr) {}

PigeonUserCredential::PigeonUserCredential(const PigeonUserCredential& other)
 : user_(other.user_ ? std::make_unique<PigeonUserDetails>(*other.user_) : nullptr),
    additional_user_info_(other.additional_user_info_ ? std::make_unique<PigeonAdditionalUserInfo>(*other.additional_user_info_) : nullptr),
    credential_(other.credential_ ? std::make_unique<PigeonAuthCredential>(*other.credential_) : nullptr) {}

PigeonUserCredential& PigeonUserCredential::operator=(const PigeonUserCredential& other) {
  user_ = other.user_ ? std::make_unique<PigeonUserDetails>(*other.user_) : nullptr;
  additional_user_info_ = other.additional_user_info_ ? std::make_unique<PigeonAdditionalUserInfo>(*other.additional_user_info_) : nullptr;
  credential_ = other.credential_ ? std::make_unique<PigeonAuthCredential>(*other.credential_) : nullptr;
  return *this;
...
void PigeonUserCredential::set_additional_user_info(const PigeonAdditionalUserInfo* value_arg) {
  additional_user_info_ = value_arg ? std::make_unique<PigeonAdditionalUserInfo>(*value_arg) : nullptr;
}
...
void PigeonUserCredential::set_credential(const PigeonAuthCredential* value_arg) {
  credential_ = value_arg ? std::make_unique<PigeonAuthCredential>(*value_arg) : nullptr;
}
...
PigeonUserCredential PigeonUserCredential::FromEncodableList(const EncodableList& list) {
  ...
  if (!encodable_user.IsNull()) {
    decoded.set_user(std::any_cast<const PigeonUserDetails&>(std::get<CustomEncodableValue>(encodable_user)));
  }
  auto& encodable_additional_user_info = list[1];
  if (!encodable_additional_user_info.IsNull()) {
    decoded.set_additional_user_info(std::any_cast<const PigeonAdditionalUserInfo&>(std::get<CustomEncodableValue>(encodable_additional_user_info)));
  }
  auto& encodable_credential = list[2];
  if (!encodable_credential.IsNull()) {
    decoded.set_credential(std::any_cast<const PigeonAuthCredential&>(std::get<CustomEncodableValue>(encodable_credential)));
  }
  return decoded;
}
...
void PigeonActionCodeSettings::set_dynamic_link_domain(const std::string_view* value_arg) {
  dynamic_link_domain_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonActionCodeSettings::set_dynamic_link_domain(std::string_view value_arg) {
...
void PigeonActionCodeSettings::set_i_o_s_bundle_id(const std::string_view* value_arg) {
...
void PigeonActionCodeSettings::set_android_package_name(const std::string_view* value_arg) {
  android_package_name_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonActionCodeSettings::set_android_package_name(std::string_view value_arg) {
...
void PigeonActionCodeSettings::set_android_minimum_version(const std::string_view* value_arg) {
  android_minimum_version_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonActionCodeSettings::set_android_minimum_version(std::string_view value_arg) {
...
void PigeonActionCodeSettings::set_link_domain(const std::string_view* value_arg) {
...
PigeonActionCodeSettings PigeonActionCodeSettings::FromEncodableList(const EncodableList& list) {
  PigeonActionCodeSettings decoded(
    std::get<std::string>(list[0]),
    std::get<bool>(list[2]),
    std::get<bool>(list[5]));
...
void PigeonFirebaseAuthSettings::set_app_verification_disabled_for_testing(bool value_arg) {
...
void PigeonFirebaseAuthSettings::set_user_access_group(const std::string_view* value_arg) {
  user_access_group_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonFirebaseAuthSettings::set_user_access_group(std::string_view value_arg) {
...
void PigeonFirebaseAuthSettings::set_phone_number(const std::string_view* value_arg) {
  phone_number_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}
...
void PigeonFirebaseAuthSettings::set_sms_code(const std::string_view* value_arg) {
...
void PigeonFirebaseAuthSettings::set_force_recaptcha_flow(const bool* value_arg) {
...
PigeonFirebaseAuthSettings PigeonFirebaseAuthSettings::FromEncodableList(const EncodableList& list) {
  PigeonFirebaseAuthSettings decoded(
    std::get<bool>(list[0]));
...
void PigeonSignInProvider::set_custom_parameters(const EncodableMap* value_arg) {
...
PigeonSignInProvider PigeonSignInProvider::FromEncodableList(const EncodableList& list) {
  PigeonSignInProvider decoded(
    std::get<std::string>(list[0]));
...
void PigeonVerifyPhoneNumberRequest::set_phone_number(const std::string_view* value_arg) {
  phone_number_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonVerifyPhoneNumberRequest::set_phone_number(std::string_view value_arg) {
  phone_number_ = value_arg;
}
...
void PigeonVerifyPhoneNumberRequest::set_force_resending_token(const int64_t* value_arg) {
  force_resending_token_ = value_arg ? std::optional<int64_t>(*value_arg) : std::nullopt;
}

void PigeonVerifyPhoneNumberRequest::set_force_resending_token(int64_t value_arg) {
  force_resending_token_ = value_arg;
}


const std::string* PigeonVerifyPhoneNumberRequest::auto_retrieved_sms_code_for_testing() const {
  return auto_retrieved_sms_code_for_testing_ ? &(*auto_retrieved_sms_code_for_testing_) : nullptr;
}

void PigeonVerifyPhoneNumberRequest::set_auto_retrieved_sms_code_for_testing(const std::string_view* value_arg) {
  auto_retrieved_sms_code_for_testing_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonVerifyPhoneNumberRequest::set_auto_retrieved_sms_code_for_testing(std::string_view value_arg) {
  auto_retrieved_sms_code_for_testing_ = value_arg;
}


const std::string* PigeonVerifyPhoneNumberRequest::multi_factor_info_id() const {
  return multi_factor_info_id_ ? &(*multi_factor_info_id_) : nullptr;
}

void PigeonVerifyPhoneNumberRequest::set_multi_factor_info_id(const std::string_view* value_arg) {
  multi_factor_info_id_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonVerifyPhoneNumberRequest::set_multi_factor_info_id(std::string_view value_arg) {
  multi_factor_info_id_ = value_arg;
}


const std::string* PigeonVerifyPhoneNumberRequest::multi_factor_session_id() const {
  return multi_factor_session_id_ ? &(*multi_factor_session_id_) : nullptr;
}

void PigeonVerifyPhoneNumberRequest::set_multi_factor_session_id(const std::string_view* value_arg) {
  multi_factor_session_id_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonVerifyPhoneNumberRequest::set_multi_factor_session_id(std::string_view value_arg) {
...
PigeonVerifyPhoneNumberRequest PigeonVerifyPhoneNumberRequest::FromEncodableList(const EncodableList& list) {
  PigeonVerifyPhoneNumberRequest decoded(
    list[1].LongValue());
  ...
  if (!encodable_force_resending_token.IsNull()) {
    decoded.set_force_resending_token(encodable_force_resending_token.LongValue());
  }
...
void PigeonIdTokenResult::set_sign_in_provider(const std::string_view* value_arg) {
...
void PigeonIdTokenResult::set_sign_in_second_factor(const std::string_view* value_arg) {
  sign_in_second_factor_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}

void PigeonIdTokenResult::set_sign_in_second_factor(std::string_view value_arg) {
...
PigeonIdTokenResult PigeonIdTokenResult::FromEncodableList(const EncodableList& list) {
  ...
  if (!encodable_expiration_timestamp.IsNull()) {
    decoded.set_expiration_timestamp(encodable_expiration_timestamp.LongValue());
  }
...
PigeonUserProfile::PigeonUserProfile(
...
PigeonUserProfile PigeonUserProfile::FromEncodableList(const EncodableList& list) {
  PigeonUserProfile decoded(
    std::get<bool>(list[2]),
    std::get<bool>(list[3]));
  auto& encodable_display_name = list[0];
  if (!encodable_display_name.IsNull()) {
...
EncodableValue PigeonInternalCodecSerializer::ReadValueOfType(
  ...
  switch (type) {
    ...
    case 130: {
        return CustomEncodableValue(PigeonMultiFactorSession::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 131: {
        return CustomEncodableValue(PigeonPhoneMultiFactorAssertion::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 132: {
        return CustomEncodableValue(PigeonMultiFactorInfo::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 133: {
    ...
    case 136: {
        return CustomEncodableValue(PigeonAdditionalUserInfo::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 137: {
        return CustomEncodableValue(PigeonAuthCredential::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 138: {
    ...
    case 141: {
        return CustomEncodableValue(PigeonActionCodeSettings::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 142: {
        return CustomEncodableValue(PigeonFirebaseAuthSettings::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 143: {
    ...
    case 145: {
        return CustomEncodableValue(PigeonIdTokenResult::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    case 146: {
...
void PigeonInternalCodecSerializer::WriteValue(
  ...
  if (const CustomEncodableValue* custom_value = std::get_if<CustomEncodableValue>(&value)) {
    ...
    if (custom_value->type() == typeid(PigeonMultiFactorSession)) {
      ...
      WriteValue(EncodableValue(std::any_cast<PigeonMultiFactorSession>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonPhoneMultiFactorAssertion)) {
      stream->WriteByte(131);
      WriteValue(EncodableValue(std::any_cast<PigeonPhoneMultiFactorAssertion>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonMultiFactorInfo)) {
      stream->WriteByte(132);
      WriteValue(EncodableValue(std::any_cast<PigeonMultiFactorInfo>(*custom_value).ToEncodableList()), stream);
      return;
    }
    ...
    if (custom_value->type() == typeid(PigeonAdditionalUserInfo)) {
      ...
      WriteValue(EncodableValue(std::any_cast<PigeonAdditionalUserInfo>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonAuthCredential)) {
      stream->WriteByte(137);
      WriteValue(EncodableValue(std::any_cast<PigeonAuthCredential>(*custom_value).ToEncodableList()), stream);
      return;
    }
    ...
    if (custom_value->type() == typeid(PigeonActionCodeSettings)) {
      ...
      WriteValue(EncodableValue(std::any_cast<PigeonActionCodeSettings>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonFirebaseAuthSettings)) {
      stream->WriteByte(142);
      WriteValue(EncodableValue(std::any_cast<PigeonFirebaseAuthSettings>(*custom_value).ToEncodableList()), stream);
      return;
    }
    ...
    if (custom_value->type() == typeid(PigeonIdTokenResult)) {
      ...
      WriteValue(EncodableValue(std::any_cast<PigeonIdTokenResult>(*custom_value).ToEncodableList()), stream);
      return;
    }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->CreateUserWithEmailAndPassword(app_arg, email_arg, password_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& app_arg = std::any_cast<const AuthPigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->SignInAnonymously(app_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->SignInWithCredential(app_arg, input_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->SignInWithCustomToken(app_arg, token_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& password_arg = std::get<std::string>(encodable_password_arg);
          api->SignInWithEmailAndPassword(app_arg, email_arg, password_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->SignInWithEmailLink(app_arg, email_arg, email_link_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& sign_in_provider_arg = std::any_cast<const PigeonSignInProvider&>(std::get<CustomEncodableValue>(encodable_sign_in_provider_arg));
          api->SignInWithProvider(app_arg, sign_in_provider_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto* action_code_settings_arg = encodable_action_code_settings_arg.IsNull() ? nullptr : &(std::any_cast<const PigeonActionCodeSettings&>(std::get<CustomEncodableValue>(encodable_action_code_settings_arg)));
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& action_code_settings_arg = std::any_cast<const PigeonActionCodeSettings&>(std::get<CustomEncodableValue>(encodable_action_code_settings_arg));
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& settings_arg = std::any_cast<const PigeonFirebaseAuthSettings&>(std::get<CustomEncodableValue>(encodable_settings_arg));
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& request_arg = std::any_cast<const PigeonVerifyPhoneNumberRequest&>(std::get<CustomEncodableValue>(encodable_request_arg));
...
void FirebaseAuthUserHostApi::SetUp(
  ...
  const std::string prepended_suffix = message_channel_suffix.length() > 0 ? std::string(".") + message_channel_suffix : "";
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_auth_platform_interface.FirebaseAuthUserHostApi.deleteUser" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_arg = std::any_cast<const AuthPigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->DeleteUser(app_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->GetIdToken(app_arg, force_refresh_arg, [reply](ErrorOr<PigeonIdTokenResult>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& input_arg = std::get<EncodableMap>(encodable_input_arg);
          api->LinkWithCredential(app_arg, input_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& sign_in_provider_arg = std::any_cast<const PigeonSignInProvider&>(std::get<CustomEncodableValue>(encodable_sign_in_provider_arg));
          api->LinkWithProvider(app_arg, sign_in_provider_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& input_arg = std::get<EncodableMap>(encodable_input_arg);
          api->ReauthenticateWithCredential(app_arg, input_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& sign_in_provider_arg = std::any_cast<const PigeonSignInProvider&>(std::get<CustomEncodableValue>(encodable_sign_in_provider_arg));
          api->ReauthenticateWithProvider(app_arg, sign_in_provider_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& app_arg = std::any_cast<const AuthPigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->Reload(app_arg, [reply](ErrorOr<PigeonUserDetails>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->Unlink(app_arg, provider_id_arg, [reply](ErrorOr<PigeonUserCredential>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          api->UpdateEmail(app_arg, new_email_arg, [reply](ErrorOr<PigeonUserDetails>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& new_password_arg = std::get<std::string>(encodable_new_password_arg);
          api->UpdatePassword(app_arg, new_password_arg, [reply](ErrorOr<PigeonUserDetails>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& input_arg = std::get<EncodableMap>(encodable_input_arg);
          api->UpdatePhoneNumber(app_arg, input_arg, [reply](ErrorOr<PigeonUserDetails>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& profile_arg = std::any_cast<const PigeonUserProfile&>(std::get<CustomEncodableValue>(encodable_profile_arg));
          api->UpdateProfile(app_arg, profile_arg, [reply](ErrorOr<PigeonUserDetails>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& app_arg = std::any_cast<const AuthPigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->GetSession(app_arg, [reply](ErrorOr<PigeonMultiFactorSession>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_assertion_arg = args.at(1);
          const auto* assertion_arg = encodable_assertion_arg.IsNull() ? nullptr : &(std::any_cast<const PigeonPhoneMultiFactorAssertion&>(std::get<CustomEncodableValue>(encodable_assertion_arg)));
